...
VALUES 
(2, 'LOC0000000', 'Warehouse 56', 1, 'http://example.com/photo1.jpg', 'Storage facility', '2023-04-23', 1, 100, True),
(2, 'LOC0000001', 'Main Office 29', 2, 'http://example.com/photo2.jpg', 'Administrative building', '2022-02-22', 1, 200, False),
(2, 'LOC0000002', 'Branch Office 72', 3, 'http://example.com/photo3.jpg', 'Subsidiary office', '2022-12-20', 5, 150, True),
(2, 'LOC0000003', 'Store Room 99', 1, 'http://example.com/photo4.jpg', 'Inventory storage', '2023-08-04', 5, 300, True),
(2, 'LOC0000004', 'Garage 65', 2, 'http://example.com/photo1.jpg', 'Vehicle storage', '2022-03-31', 4, 250, True),
(3, 'LOC0000000', 'Warehouse 76', 1, 'http://example.com/photo1.jpg', 'Storage facility', '2022-11-12', 2, 100, False),
(4, 'LOC0000000', 'Warehouse 25', 1, 'http://example.com/photo1.jpg', 'Storage facility', '2023-07-04', 5, 100, True);

INSERT INTO ITEM_MASTER (userID, item_number, alt_item_number, item_name, item_descr, item_barcode, item_weight, item_height, item_width, image_link_ID, item_type, manufacturer_ID, item_files, item_CreateDate, item_LastModified, item_IsActive, item_uom,item_prime_image)
VALUES 
(2, 92856, 36473, 'Item45', 'Description for item Item45', '97212895239098626276', 4.51, 8.15, 14.58, 8, 1, 95, 'manual_92856.pdf', '2024-02-11 10:31:37', '2024-02-11 10:31:37', False, 'kg',"https://www.dropbox.com/scl/fi/jrea011jxfcdnntc50zdx/IMG_1727.jpg?rlkey=thdko1a2pn7d34lgw8erc8olz&dl=0"),
(2, 65493, 42691, 'Item30', 'Description for item Item30', '61011884701793955833', 6.25, 7.9, 9.73, 34, 8, 40, 'manual_65493.pdf', '2024-02-11 10:31:37', '2024-02-11 10:31:37', False, 'pcs',"https://www.dropbox.com/scl/fi/jrea011jxfcdnntc50zdx/IMG_1727.jpg?rlkey=thdko1a2pn7d34lgw8erc8olz&dl=0"),
(3, 59418, 41136, 'Item91', 'Description for item Item91', '79309134954547787172', 16.76, 8.0, 5.66, 86, 2, 91, 'manual_59418.pdf', '2024-02-11 10:31:37', '2024-02-11 10:31:37', True, 'pair',"https://www.dropbox.com/scl/fi/jrea011jxfcdnntc50zdx/IMG_1727.jpg?rlkey=thdko1a2pn7d34lgw8erc8olz&dl=0"),
(3, 93606, 84776, 'Item85', 'Description for item Item85', '82747787670334296495', 13.16, 18.52, 19.18, 86, 3, 74, 'manual_93606.pdf', '2024-02-11 10:31:37', '2024-02-11 10:31:37', False, 'pair',"https://www.dropbox.com/scl/fi/jrea011jxfcdnntc50zdx/IMG_1727.jpg?rlkey=thdko1a2pn7d34lgw8erc8olz&dl=0"),
(4, 75137, 33052, 'Item76', 'Description for item Item76', '66304191440970520537', 11.3, 10.52, 3.64, 66, 1, 67, 'manual_75137.pdf', '2024-02-11 10:31:37', '2024-02-11 10:31:37', True, 'kg',"https://www.dropbox.com/scl/fi/jrea011jxfcdnntc50zdx/IMG_1727.jpg?rlkey=thdko1a2pn7d34lgw8erc8olz&dl=0"),
...
(4, 90265, 96692, 'Item5', 'Description for item Item5', '17602416867825795479', 12.69, 7.59, 6.49, 41, 1, 79, 'manual_90265.pdf', '2024-02-11 10:31:37', '2024-02-11 10:31:37', False, 'set');
