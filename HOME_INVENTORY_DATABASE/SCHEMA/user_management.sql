...
CREATE TABLE users (
    ...
    user_status TINYINT REFERENCES user_status (statusID),
    -- Active/not active/ paused
    user_type INT REFERENCES user_types (user_typeID) user_database_role int REFERENCES database_roles (role_id), failed_login_attempts TINYINT,
    -- how many times a failed attempt / use with user_last_logon field
